                    ...
                    <div class="table-scroll">
                        <table class="transactions-table history-table">
                            ...
                            <?php if (empty($reservations)): ?>
                                <tr class="empty-row"><td colspan="8">No reservations match these filters.</td></tr>
                            <?php else: foreach ($reservations as $r): ?>
                                <tr class="hist-row" data-detail-key="res-<?= (int) $r['id'] ?>" onclick="openHistModal('res-<?= (int) $r['id'] ?>')">
                                    ...
                                    <td><?= peso($r['total']) ?></td>
                                    <td><span class="status-badge status-<?= htmlspecialchars($r['status']) ?>"><?= ucfirst(htmlspecialchars($r['status'])) ?></span></td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="process-btn" data-detail-key="res-<?= (int) $r['id'] ?>" onclick="event.stopPropagation(); processReservation('res-<?= (int) $r['id'] ?>')"><i class="fa-solid fa-cash-register"></i> Process</button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
