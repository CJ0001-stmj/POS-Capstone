...
<div class="app-shell">
    ...
    <?php
    // Cashier gets own nav (sidebar-cashier.php), everyone else gets the
    // shared admin/manager nav. Same DB either way - db.php untouched.
...
<div class="pos-modal-overlay" id="receiptOverlay">
    <div class="pos-modal pos-receipt-modal">
        ...
        <div class="pos-receipt-followup" id="receiptFollowup" style="display:none;">
            <a href="/pos/receipt-history.php" id="viewReceiptLink" target="_blank" class="table-link"><i class="fa-solid fa-clock-rotate-left"></i> View in Receipt History</a>
            <a href="/pos/stock-monitoring.php" target="_blank" class="table-link"><i class="fa-solid fa-boxes-stacked"></i> View Stock Monitoring</a>
        </div>
    </div>
</div>
